    ...
    <div class="container">
        <div class="row">            
            <div class="col-md-12">
                ...
                <p>Bạn có thắc mắc chưa được giải đáp, đừng ngần ngại nhắn tin cho chúng tôi</p>
                <div class="row cform">
                    <div class="col-md-8">
...
?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="visitor_name" placeholder="Nhập tên của bạn">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Địa chỉ Email</label>
                                        <input type="email" class="form-control" name="visitor_email" placeholder="Nhập email của bạn">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Số điện thoại</label>
                                        <input type="text" class="form-control" name="visitor_phone" placeholder="Nhập SĐT của bạn">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Tin nhắn</label>
                                        <textarea name="visitor_message" class="form-control" rows="9" cols="25" placeholder="Viết tin nhắn cho chúng tôi"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                ...
                <h3>Tìm kiếm chúng tôi trên bảng đồ</h3>
