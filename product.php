...
if(isset($_POST['form_add_to_cart'])) {
	...
	if($_POST['p_qty'] > $current_p_qty):
		$temp_msg = 'Xin lỗi! Bạn chỉ có thể chọn tối đa '.$current_p_qty.' sản phẩm';
		?>
...
<div class="page">
	<div class="container">
     ...
     <!-- ShareThis BEGIN -->
     <div ><p class="p-reaction">Bạn thấy thông tin sản phẩm này hữu ích chứ ?</p>
     <div class="sharethis-inline-reaction-buttons"></div></div><!-- ShareThis END -->
					<div class="row">
						<div class="col-md-12">
							<!-- Nav tabs -->
