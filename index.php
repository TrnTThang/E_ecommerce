                ...
                <div class="product-carousel">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                <h3><a href="san-pham-<?php echo $row['p_id']; ?>.html"><?php echo $row['p_name']; ?></a></h3>
                                <h4>
                                ...
                                <?php else: ?>
                                    <p><a href="san-pham-<?php echo $row['p_id']; ?>.html"><i class="fa fa-shopping-cart"></i> Thêm vào giỏi hàng</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <?php else: ?>
                                    <p><a href="san-pham-<?php echo $row['p_id']; ?>.html"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng</a></p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php
