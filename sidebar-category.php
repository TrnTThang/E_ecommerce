            ...
            <?php
                ...
                foreach ($result as $row) {
                    ...
                    <li class="cat-level-1 deeper parent">
                        <a class="" href="<?php echo $row['tcat_id']; ?>-top-category.html">
                        ...
                        <ul class="children nav-child unstyled small collapse" id="cat-lvl1-id-<?php echo $i; ?>">
                            ...
                            foreach ($result1 as $row1) {
                                ...
                                <li class="deeper parent">
                                    <a class="" href="<?php echo $row1['mcat_id']; ?>-mid-category.html">
                                        ...
                                        <?php
                                            ...
                                            foreach ($result2 as $row2) {
                                                ...
                                                <li class="item-<?php echo $i.$j.$k; ?>">
                                                    <a class="" href="<?php echo $row2['ecat_id']; ?>-end-category.html">
