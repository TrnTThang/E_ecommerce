...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn danh mục cao thứ 1<br>";
    }

    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "Tên danh mục cao thứ 2 không được để trống<br>";
    }
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Chỉnh sửa danh mục cao thứ 2</h1>
	</div>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Tên danh mục cao thứ 1 <span>*</span></label>
                    <div class="col-sm-4">
                        <select name="tcat_id" class="form-control select2">
                            <option value="">Chọn danh mục cao thứ 1</option>
                            <?php
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Tên danh mục cao thứ 2 <span>*</span></label>
                    <div class="col-sm-4">
