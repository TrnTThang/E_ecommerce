...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn địa phương<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Địa phương đã tồn tại<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Phí giao hàng cập nhật thành công';
    }
}
?>
            ...
            <div class="box box-info">
                <div class="box-body">
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Chọn địa phương <span>*</span></label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">Phí giao hàng <span>*</span></label>
                        <div class="col-sm-4">
