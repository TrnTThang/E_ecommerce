        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover table-striped">
			<thead>
			    <tr>
			        <th>#</th>
			        <th>Tên danh mục cao thứ 2</th>
                    <th>Tên danh mục cao thứ 1</th>
			        <th>Action</th>
			    </tr>
			</thead>
            <tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Hãy cẩn thận! Tất cả các sản phẩm và danh mục cấp 2 trong danh mục cấp 1 này sẽ bị xóa khỏi tất cả các bảng như bảng đặt hàng, bảng thanh toán, bảng kích thước, bảng màu, bảng xếp hạng, v.v.</p>
            </div>
