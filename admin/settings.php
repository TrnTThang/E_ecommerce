...
if(isset($_POST['form1'])) {
    ...
    if($path == '') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Hình ảnh phải có định dạng jpg, jpeg, gif hoặc png file<br>';
        }
    }
    ...
    if($valid == 1) {
        ...
        $success_message = 'Cập nhật logo thành công.';
...
if(isset($_POST['form2'])) {
    ...
    if($valid == 1) {
        ...
        $success_message = 'Favicon cập nhật thành công !';
        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_4" data-toggle="tab">Tin nhắn thông báo</a></li>
                        ...
                        <li><a href="#tab_9" data-toggle="tab">Thanh toán</a></li>
                        <li><a href="#tab_10" data-toggle="tab">Nhúng script</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Bản quyền </label>
                                        <div class="col-sm-9">
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Nhúng bản đồ </label>
                                        <div class="col-sm-9">
                        ...
                        <div class="tab-pane" id="tab_4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Email cảm ơn</label>
                                        <div class="col-sm-8">
                                            <textarea class="form-control" name="receive_email_thank_you_message"><?php echo $receive_email_thank_you_message; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Tin nhắn xác thực quên Password </label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_5">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Có bao nhiêu sản phẩm nổi bật?<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_featured_product_home" value="<?php echo $total_featured_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Có bao nhiêu sản phẩm mới nhất?<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_latest_product_home" value="<?php echo $total_latest_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Có bao nhiêu sản phẩm phổ biến?<span>*</span></label>
                                        <div class="col-sm-2">
                        ...
                        <div class="tab-pane" id="tab_6">
                        	...
                        	<h3>Các phần On và Off</h3>
                            <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Bộ phận dịch vụ </label>
                                        <div class="col-sm-4">
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <div class="box box-info">
                                <div class="box-body">                                          
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Bản tin</label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_7">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <form action="" method="post" enctype="multipart/form-data">
                                    <td style="width:50%">
                                        <h4>Banner trang Thủ tục thanh toán</h4>
                                        <p>
                                            <img src="<?php echo '../assets/uploads/'.$banner_checkout; ?>" alt="" style="width: 100%;height:auto;">  
                                        </p>                                        
                                    </td>
                                    <td style="width:50%">
                                        <h4>Thay đổi banner trang Thủ tục thanh toán</h4>
                                        Chọn ảnh<input type="file" name="photo">
                               ...
                               <!-- <tr>
                                    ...
                                    <td style="width:50%">
                                        <h4>Thay đổi Blog Page Banner</h4>
                                        Chọn ảnh<input type="file" name="photo">
                                        <input type="submit" class="btn btn-primary btn-xs" value="Thay đổi" style="margin-top:10px;" name="form7_10">
                                    </td>
                                    </form>
                                </tr>-->
                            </table>
                                ...
                                <div class="box box-info">
                                    <div class="box-body">
                                      ...
                                      <!-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Thông tin tài khoản Ngân hàng </label>
                                            <div class="col-sm-5">
